    ...
    ============================-->
        ...
        <?php
                    ...
                    ?>
                            ...
                            <form action="controller/cpayment.php" method="POST">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input class="form-control" name="csid" readonly type="hidden" value="<?php echo $row['cs_id']; ?>">
                                            ...
                                            <div class="d-block my-3">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <div style="display: none;" id="upi_div">
                                                        <b>scan and pay</b>
                                                        <img src="Admin\assets\images\qr_code1.jpg" style="width:300px;height:300px;">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="cp" class="btn btn-primary">Submit</button>
                                    </div>
