...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        <!--End topbar header-->
        <?php
                                            $stmt=$admin->ret("SELECT * FROM `cpayment` INNER JOIN `customize` ON customize.cs_id=cpayment.cs_id INNER JOIN `user` ON user.uid=customize.uid WHERE cpayment.cp_id='$cpid'
                                            ");
                            ...
                            <div class="card-body">
                                ...
                                <div class=" p-3">
                                    ...
                                    <div class="tab-pane" id="edit">
                                        <form action="controller/update_cus_payment.php" method="POST">
                                            <input type="hidden" name="cpid" value="<?php echo $cpid ?>" id="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['pay_method'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Transaction Id</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['trans_id'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Card Name</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['card_name'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Card Number</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['card_no'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" name="adv" readonly type="text" value="<?php echo $row['advance'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">BALANCE</label>
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['balance'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" readonly type="text" value="<?php echo $row['received'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
