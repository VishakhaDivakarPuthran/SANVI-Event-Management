        ...
        <div class="modal-dialog " role="document" >
          <div class="modal-content" style="width:700px">
            ...
            <div class="modal-body ">
              <form method="POST" action="controller/customize.php">
                <input type="hidden" name="sid" value="<?php echo $sid ?>" id="">
                <input type="hidden" name="pid" value="<?php echo $pid ?>" id="">
                <div class="form-group">
                  <input type="date" class="form-control" required name="date" placeholder="Time">
                </div>
                <div class="form-group">
                  <input type="time" class="form-control" required name="time" placeholder="Date">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" required name="venue" placeholder="Venue">
                </div>
                <div class="form-group">
                ...
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" required name="unit" placeholder="Unit" id="unit" onchange="show()">
                </div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" readonly value="<?php echo $row['p_amount'] ?>" id="amt" name="amt" placeholder="Amount" >
                </div>
                <div class="form-group col-md-4">
                  <input type="text" class="form-control" readonly name="tot" id="tot" placeholder="Total">
                </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <textarea id="" class="form-control" required  name="disc" cols="30" rows="10"></textarea>
                </div>
              
                <div class="text-center">
                  <button type="submit" class="btn" name="cust">Order Now</button>
                </div>
              </form>
            </div>
          </div><!-- /.modal-content -->
