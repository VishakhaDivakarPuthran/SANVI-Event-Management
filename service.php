    ...
    <section id="hotels" class="section-with-bg wow fadeInUp">
      ...
      <div class="container">
        <div class="section-header">
          <h2>IT'S SOMETHING WE DO BETTER</h2>
          <p>SEARCH YOUR NEEDS</p>
        </div>

        <div class="row">
<?php
$stmt=$admin->ret("SELECT * FROM `service` WHERE `catid`='$catid'");
while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
?>
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="admin/controller/<?php echo $row['image'] ?>" alt="Hotel 1" class="img-fluid" style="width:350px;height:300px;object-fit:cover">
              </div>
              <h3><a href="#"><?php echo $row['sname'] ?></a></h3>
              
              <div style="display: flex;justify-content:center" class="mb-3">
              <a href="view_package.php?sid=<?php echo $row['sid'] ?>" class="btn btn-info w-50 text-white">View More</a>
              </div>
            </div>
          </div>
