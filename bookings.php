...
<body>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if($row['bstatus']=='placed'){?>
                                <a href="controller/cancel_booking.php?bid=<?php echo $row['bid'] ?>"><button class="btn btn-danger">
                                    Cancel
                                </button></a>

                                <?php }elseif ($row['bstatus'] == 'Accepted') { ?>
                                    <a href="booking_payment.php?bid=<?php echo $row['bid']?>"><button class="btn btn-success" >Pay</button></a>
                                <?php }elseif($row['bstatus']=='completed'){ ?>
  ...
  data-mdb-whatever="@mdo">Feedback</button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="myModal<?php echo $row['bid']?>">
